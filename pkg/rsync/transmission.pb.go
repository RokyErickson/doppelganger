...
package rsync // import "github.com/RokyErickson/doppelganger/pkg/rsync"
...
func (dst *Transmission) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Transmission.Merge(dst, src)
}
